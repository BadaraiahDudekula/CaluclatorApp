...
function Keypad({ handleClick, handleClear, handleCaluclate }) {
    return (
        <div className='keypad'>
            ...
            <div className='row'>
                ...
                <button  onClick={() => { handleCaluclate() }} className='fk' >=</button>
                <button onClick={() => { handleClear() }} className='fk'>C</button >
                <button onClick={() => { handleClick("+") }} className='operator'>+</button >
            </div>
        </div>
    )
